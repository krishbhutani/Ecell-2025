                ...
                <div className='flex gap-8 flex-wrap justify-center my-9'>
                    ...
                    <div className=' bg-slate-500 rounded-lg border-black border-2 shadow-[#310747] shadow-xl   h-[655px]  w-72'>
                        ...
                        <div className='relative rounded-b-lg bg-[#310742a4] h-[399px] top-0'>
                            ...
                            <div className='w-full h-px bg-black'></div>
                            <p className='px-4 py-2 h-auto text-white'>Entrepreneurship drives change, and the E-Cell offers a dynamic platform for shaping innovative ideas and nurturing aspirations. It inspires tomorrow's leaders to turn their visions into reality, celebrating the entrepreneurial mindset within our vibrant college community. Best wishes for ongoing success and meaningful impact in all your endeavors!</p>
