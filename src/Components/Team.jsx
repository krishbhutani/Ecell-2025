                ...
                <div className=' grid sm:grid-cols-12 grid-cols-3  gap-6 mt-7 mb-7 sm:px-0 px-10'>
                    <div class="grid grid-cols-subgrid sm:col-start-5 col-start-1 gap-10 col-span-12">
                        <div className=' bg-slate-500 rounded-lg border-black border-2 shadow-[#310747] shadow-xl  sm:col-span-3 col-span-12 h-[655px]  w-auto'>
                            <div >
                                <img className="h-64 w-full object-cover rounded-t-lg " src={assets.jp} alt="" />
                            </div>
                            ...
                            <div className='relative rounded-b-lg bg-[#310742a4] h-[399px] top-0'>
                                ...
                                <div className='w-full h-px bg-black'></div>
                                <p className='px-4 py-2 h-auto text-white'>The Entrepreneurship Cell (E-Cell) at NIT Hamirpur promotes innovation by helping students transform ideas into impactful ventures. Through workshops and mentorship, it equips them with essential skills, bridging academia and industry, inspiring job creation, and empowering future leaders to drive positive societal change through entrepreneurship.</p>
                        ...
                        <div className=' bg-slate-500 rounded-lg border-black border-2 shadow-[#310747] shadow-xl  sm:col-span-3 col-span-12 h-[655px]  w-auto'>
                            ...
                            <div className='relative rounded-b-lg bg-[#310742a4] h-[399px] top-0'>
                                ...
                                <div className='w-full h-px bg-black'></div>
                                <p className='px-4 py-2 h-auto text-white'>Entrepreneurship drives change, and the E-Cell offers a platform for shaping ideas and nurturing aspirations. It inspires tomorrow's leaders to turn visions into reality, celebrating the entrepreneurial mindset within our college community. Best wishes for ongoing success and meaningful impact!</p>
                    ...
                    <div className=' bg-slate-500 rounded-lg border-black border-2 shadow-[#310747] shadow-xl  sm:col-span-3 col-span-12 h-[655px]  w-auto'>
                            ...
                            <div className='relative rounded-b-lg bg-[#310742a4] h-[399px] top-0'>
                                ...
                                <div className='w-full h-px bg-black'></div>
                                <p className='px-4 py-2 h-auto text-white'>It is with great enthusiasm and pride that I welcome you to E-Cell NIT Hamirpur, a celebration of innovation, entrepreneurship, and collaborative growth. E-Cell stands as a testament to our commitment to fostering an ecosystem where ideas flourish and ambitions transform into impactful realities.
                                Let's ideate, innovate, and impact together!</p>
