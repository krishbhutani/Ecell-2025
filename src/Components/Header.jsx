        ...
        <div className='w-full bg-[#F3F2E3] h-max pb-32'>
            ...
            <div className='flex pt-6 sm:pt-28 sm:pl-32 pl-5 px-2  sm:px-0'>
                ...
                className=' w-full sm:w-7/12 m-auto'>
                    <div className='hidden sm:block pb-5 text-3xl sm:text-7xl  font-extrabold text-transparent bg-gradient-to-bl from-gray-800 via-blue-700 to-gray-900 bg-clip-text'>Entrepreneurship Cell</div>
                    <div className='sm:hidden block pb-3 text-5xl sm:text-7xl font-extrabold text-transparent bg-gradient-to-bl from-gray-800 via-blue-700 to-gray-900 bg-clip-text'>E-Cell</div>
                    <div className='pb-2 text-5xl sm:text-7xl font-extrabold text-transparent bg-gradient-to-bl from-gray-800 via-blue-700 to-gray-900 bg-clip-text'>NIT Hamirpur</div>
