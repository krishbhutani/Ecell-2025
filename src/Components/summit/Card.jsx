...
const data = [
...

  {
    img:`${assets.Event_3}`,
    title:"Find The Bug",
    subtitle:"Think like a detective, act like a strategist! Uncover the hidden flaws in company workflows and propose genius solutions to tackle real-world business conundrums. It's not just a problem— it's a playground for your innovative mind."
